# Fiche questions-réponses — Module 21 — Other Monitoring Tools

## Objectif de la fiche

Réviser le module **21 — Other Monitoring Tools** sous forme de questions-réponses opérationnelles.
...
### Q01. Quel est l’objectif principal du module 21 ?

utiliser AHF, TFA, Exachk, ORAchk, OSWatcher, logs et rapports santé.

### Q02. Pourquoi ce sujet est-il important sur Exadata ?

Ces outils accélèrent la collecte et la préparation support, mais ne remplacent pas la compréhension technique.

### Q03. Quels sont les concepts clés à connaître ?

Les concepts clés sont : **AHF**, **TFA**, **Exachk**, **ORAchk**, **OSWatcher**, **Logs**, **Timeline**, **SR**.

### Q04. Quels composants Exadata sont concernés ?

Les composants concernés sont : Database, GI, ASM, Storage Cells, OS, Enterprise Manager, Oracle Support.
...
### Q09. Que faut-il retenir sur **OSWatcher** ?

**OSWatcher** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q10. Que faut-il retenir sur **Logs** ?

**Logs** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q11. Que faut-il retenir sur **Timeline** ?
...
L’erreur fréquente est de **envoyer une collecte massive sans timeline ni impact métier.**. La correction consiste à revenir à la méthode : symptôme → période → composants → preuves read-only → interprétation → décision.

### Q19. Quel cas pratique illustre le module ?

Oracle Support demande des diagnostics après un incident RAC/storage intermittent.
...
AHF, TFA, Exachk, ORAchk, OSWatcher, Logs, Timeline, SR.

### Q26. Quelle phrase de synthèse retenir ?

Le module **21 — Other Monitoring Tools** doit être abordé avec une logique de preuve : comprendre les composants, lire les métriques pertinentes, corréler avec le workload et ne conclure qu’après validation technique.
...
- Expliquez **OSWatcher** en une phrase et donnez une preuve read-only associée.

- Appliquez la méthode au cas suivant : **Oracle Support demande des diagnostics après un incident RAC/storage intermittent.**
