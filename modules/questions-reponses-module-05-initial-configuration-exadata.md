# Fiche questions-réponses — Module 05 — Initial Configuration Exadata

## Objectif de la fiche

Réviser le module **05 — Initial Configuration Exadata** sous forme de questions-réponses opérationnelles.
...
### Q01. Quel est l’objectif principal du module 05 ?

comprendre la configuration initiale Exadata avec OEDA/OECA, naming, réseaux, ASM, DB homes et services.

### Q02. Pourquoi ce sujet est-il important sur Exadata ?

La configuration initiale détermine la cohérence de toute la plateforme : noms, IP, SCAN, DATA, RECO, Oracle Homes et services.

### Q03. Quels sont les concepts clés à connaître ?

Les concepts clés sont : **OEDA**, **OECA**, **worksheet**, **naming**, **SCAN**, **ASM**, **DATA**, **RECO**, **DB Home**.

### Q04. Quels composants Exadata sont concernés ?

Les composants concernés sont : DB servers, Storage Cells, Grid Infrastructure, ASM, listeners, SCAN, Oracle Homes.

### Q05. Que faut-il retenir sur **OEDA** ?

**OEDA** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q06. Que faut-il retenir sur **OECA** ?

**OECA** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q07. Que faut-il retenir sur **worksheet** ?

**worksheet** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q08. Que faut-il retenir sur **naming** ?

**naming** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.
...
### Q10. Que faut-il retenir sur **ASM** ?
...
### Q11. Que faut-il retenir sur **DATA** ?
...
### Q12. Que faut-il retenir sur **RECO** ?
...
L’erreur fréquente est de **modifier manuellement sans comprendre ce qui a été généré par OEDA.**. La correction consiste à revenir à la méthode : symptôme → période → composants → preuves read-only → interprétation → décision.

### Q19. Quel cas pratique illustre le module ?

Après déploiement initial, l’équipe doit vérifier que SCAN, ASM, services et Storage Cells sont correctement configurés.
...
OEDA, OECA, worksheet, naming, SCAN, ASM, DATA, RECO, DB Home.

### Q26. Quelle phrase de synthèse retenir ?

Le module **05 — Initial Configuration Exadata** doit être abordé avec une logique de preuve : comprendre les composants, lire les métriques pertinentes, corréler avec le workload et ne conclure qu’après validation technique.

## Mini-test

- Expliquez **OEDA** en une phrase et donnez une preuve read-only associée.

- Expliquez **OECA** en une phrase et donnez une preuve read-only associée.

- Expliquez **worksheet** en une phrase et donnez une preuve read-only associée.

- Expliquez **naming** en une phrase et donnez une preuve read-only associée.

- Expliquez **SCAN** en une phrase et donnez une preuve read-only associée.

- Appliquez la méthode au cas suivant : **Après déploiement initial, l’équipe doit vérifier que SCAN, ASM, services et Storage Cells sont correctement configurés.**
