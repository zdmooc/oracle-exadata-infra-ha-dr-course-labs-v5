# Fiche questions-réponses — Module 25 — Patching

## Objectif de la fiche

Réviser le module **25 — Patching** sous forme de questions-réponses opérationnelles.
...
### Q01. Quel est l’objectif principal du module 25 ?
...
Le patching Exadata touche plusieurs couches et peut provoquer indisponibilité ou incohérence si mal préparé.

### Q03. Quels sont les concepts clés à connaître ?

Les concepts clés sont : **Rolling Patch**, **Non-Rolling Patch**, **Pre-check**, **Post-check**, **Rollback**, **Exachk**, **CAB**, **Go/No-Go**.

### Q04. Quels composants Exadata sont concernés ?

Les composants concernés sont : DB Home, Grid Infrastructure, Exadata System Software, Storage Cells, DB servers, EM Agent, AHF.

### Q05. Que faut-il retenir sur **Rolling Patch** ?

**Rolling Patch** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q06. Que faut-il retenir sur **Non-Rolling Patch** ?

**Non-Rolling Patch** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q07. Que faut-il retenir sur **Pre-check** ?

**Pre-check** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q08. Que faut-il retenir sur **Post-check** ?

**Post-check** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q09. Que faut-il retenir sur **Rollback** ?

**Rollback** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q10. Que faut-il retenir sur **Exachk** ?
...
### Q11. Que faut-il retenir sur **CAB** ?

**CAB** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q12. Que faut-il retenir sur **Go/No-Go** ?

**Go/No-Go** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.
...
L’erreur fréquente est de **penser que rolling patch signifie absence d’impact.**. La correction consiste à revenir à la méthode : symptôme → période → composants → preuves read-only → interprétation → décision.
...
Rolling Patch, Non-Rolling Patch, Pre-check, Post-check, Rollback, Exachk, CAB, Go/No-Go.

### Q26. Quelle phrase de synthèse retenir ?

Le module **25 — Patching** doit être abordé avec une logique de preuve : comprendre les composants, lire les métriques pertinentes, corréler avec le workload et ne conclure qu’après validation technique.

## Mini-test

- Expliquez **Rolling Patch** en une phrase et donnez une preuve read-only associée.

- Expliquez **Non-Rolling Patch** en une phrase et donnez une preuve read-only associée.

- Expliquez **Pre-check** en une phrase et donnez une preuve read-only associée.

- Expliquez **Post-check** en une phrase et donnez une preuve read-only associée.

- Expliquez **Rollback** en une phrase et donnez une preuve read-only associée.

- Appliquez la méthode au cas suivant : **Une campagne patch trimestrielle doit être préparée pour une base critique.**
