# Fiche questions-réponses — Module 11 — Consolidation Exadata

## Objectif de la fiche

Réviser le module **11 — Consolidation Exadata** sous forme de questions-réponses opérationnelles.
...
### Q01. Quel est l’objectif principal du module 11 ?

comprendre la consolidation contrôlée : bases, PDB, services, workloads, Resource Manager, IORM, SLA et gouvernance.

### Q02. Pourquoi ce sujet est-il important sur Exadata ?

La consolidation augmente l’utilisation de la plateforme, mais crée des interdépendances entre workloads.

### Q03. Quels sont les concepts clés à connaître ?

Les concepts clés sont : **Consolidation**, **PDB**, **Service RAC**, **SLA**, **Noisy Neighbor**, **Resource Manager**, **IORM**, **RPO/RTO**.

### Q04. Quels composants Exadata sont concernés ?

Les composants concernés sont : bases, PDB, services, DB servers, Storage Cells, ASM, monitoring.

### Q05. Que faut-il retenir sur **Consolidation** ?

**Consolidation** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q06. Que faut-il retenir sur **PDB** ?

**PDB** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q07. Que faut-il retenir sur **Service RAC** ?
...
### Q08. Que faut-il retenir sur **SLA** ?

**SLA** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.
...
### Q10. Que faut-il retenir sur **Resource Manager** ?

**Resource Manager** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.

### Q11. Que faut-il retenir sur **IORM** ?
...
### Q12. Que faut-il retenir sur **RPO/RTO** ?

**RPO/RTO** doit être compris dans le contexte Exadata : il faut le relier aux composants concernés, au workload, aux métriques observables et à l’impact métier. La bonne pratique consiste à ne jamais l’analyser isolément.
...
L’erreur fréquente est de **consolider sans matrice workload/SLA/ressources.**. La correction consiste à revenir à la méthode : symptôme → période → composants → preuves read-only → interprétation → décision.

### Q19. Quel cas pratique illustre le module ?

Une nouvelle application analytique doit être ajoutée sur un Exadata déjà utilisé par l’OLTP et le batch.
...
Consolidation, PDB, Service RAC, SLA, Noisy Neighbor, Resource Manager, IORM, RPO/RTO.

### Q26. Quelle phrase de synthèse retenir ?

Le module **11 — Consolidation Exadata** doit être abordé avec une logique de preuve : comprendre les composants, lire les métriques pertinentes, corréler avec le workload et ne conclure qu’après validation technique.

## Mini-test

- Expliquez **Consolidation** en une phrase et donnez une preuve read-only associée.

- Expliquez **PDB** en une phrase et donnez une preuve read-only associée.

- Expliquez **Service RAC** en une phrase et donnez une preuve read-only associée.

- Expliquez **SLA** en une phrase et donnez une preuve read-only associée.

- Expliquez **Noisy Neighbor** en une phrase et donnez une preuve read-only associée.

- Appliquez la méthode au cas suivant : **Une nouvelle application analytique doit être ajoutée sur un Exadata déjà utilisé par l’OLTP et le batch.**
