# Fiche questions-réponses — Module 06 — Exadata Storage Server Configuration

## Objectif de la fiche

Réviser le module **06 — Exadata Storage Server Configuration** sous forme de questions-réponses opérationnelles.
...
### Q01. Quel est l’objectif principal du module 06 ?

comprendre la configuration des Storage Cells, physical disks, cell disks, grid disks, Flash Cache et CellCLI.

### Q02. Pourquoi ce sujet est-il important sur Exadata ?

Les Storage Cells sont le cœur du stockage intelligent Exadata : elles exécutent les fonctions d’offload et exposent les métriques I/O.

### Q03. Quels sont les concepts clés à connaître ?

Les concepts clés sont : **Storage Cell**, **Physical Disk**, **Cell Disk**, **Grid Disk**, **Flash Cache**, **Flash Log**, **CellCLI**, **Alerthistory**.

### Q04. Quels composants Exadata sont concernés ?

Les composants concernés sont : physical disks, cell disks, grid disks, flash, Storage Cell, ASM.
...
### Q09. Que faut-il retenir sur **Flash Cache** ?
...
### Q10. Que faut-il retenir sur **Flash Log** ?
...
### Q11. Que faut-il retenir sur **CellCLI** ?
...
### Q12. Que faut-il retenir sur **Alerthistory** ?
...
L’erreur fréquente est de **confondre disque physique, cell disk et grid disk.**. La correction consiste à revenir à la méthode : symptôme → période → composants → preuves read-only → interprétation → décision.

### Q19. Quel cas pratique illustre le module ?

Une Storage Cell signale une alerte disque ; il faut distinguer physical disk, cell disk, grid disk et impact ASM.
...
Storage Cell, Physical Disk, Cell Disk, Grid Disk, Flash Cache, Flash Log, CellCLI, Alerthistory.

### Q26. Quelle phrase de synthèse retenir ?

Le module **06 — Exadata Storage Server Configuration** doit être abordé avec une logique de preuve : comprendre les composants, lire les métriques pertinentes, corréler avec le workload et ne conclure qu’après validation technique.
...
- Appliquez la méthode au cas suivant : **Une Storage Cell signale une alerte disque ; il faut distinguer physical disk, cell disk, grid disk et impact ASM.**
